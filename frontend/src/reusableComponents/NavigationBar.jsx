    ...
    <AppBar position="static " sx={{ zIndex: 1000 }}>
      <Container maxWidth="xl" sx={{ zIndex: 1000 }}>
        <Toolbar disableGutters sx={{ zIndex: 1000 }}>
          <Box
            sx={{ display: "none", md: "flex", zIndex: 10000 }}
            onClick={() => handleClick("dashboard")}
          >
            <img
              className="w-28  bg-white p-2 rounded-xl mr-8"
              src={sltlogo}
              alt=""
            />
          </Box>
          ...
          <img
            className="w-28   bg-white p-2 rounded-xl mr-2 my-2"
            src={sltlogo}
            alt=""
          />
